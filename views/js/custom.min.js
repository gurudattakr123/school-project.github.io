...
$(function() {
 ...
 $('.add').click(function() {
    $('.block:first').before(' <div class="form-group row block"><div class="col-sm-3"><div class="input-group"><input type="text" class="form-control" name = "subject_name" placeholder="Subject Name"></div></div><div class="col-sm-4"><div class="input-group"><input type="date" class="form-control" name = "dot" placeholder="Exan date"></div></div><div class="col-sm-2"><div class="input-group"><input type="time" class="form-control" name = "start_time" placeholder="Start Time"></div></div><div class="col-sm-2"><div class="input-group"><input type="time" class="form-control" name = "start_time" placeholder="Start Time"></div></div><span class="close">x</span></div>');
});
$('.optionBox').on('click','.close',function() {
 	$(this).parent().remove();
});

var $class = $('#attendance_class');
var $section = $('#attendance_section');
$options = $section.find( 'option' );
alert(options)
$class.on( 'change', function() {
$section.html( $options.filter( '[value="' + this.value + '"]' ) );
} ).trigger( 'change' );